...
export const FEW_SHOT_EXAMPLES = [
  ...
  {
    label: "侮辱語・意味的ハラスメント（labor_consultation）",
    stageTitle: "遅刻",
    mistake: "田中が朝の会議に20分遅刻した",
    inputText:
      "愚かで卑しい。お前は誰より劣る存在だ。こんな仕事もまともにできない。",
    scores: {
      harassmentScore: 88,
...
■ 軸1 ハラスメント度（0=安全、100=危険・高いほど悪い）
  ...
  80-100: 解雇示唆・重度の人格否定（辞めろ、クビ、バカ、愚か、卑しい）

  【ハラスメント度は「意味・文脈」で判定する（最重要）】
  登録キーワードの有無だけで判断しない。指導文全体のトーン・意図・相手への攻撃性を読む。
  リストに無い表現でも、人格・能力を侮辱・蔑視・見下しする意味なら高く採点すること。
  例（いずれもハラスメント度 60〜90 以上）:
  - 愚か、卑しい、劣る、情けない、見るに耐えない、落ちぶれ、役立たず同様の意味
  - 業務指導ではなく、相手の人格や存在価値を否定する言い回し
  - 感情的な糾弾・見下し・嘲り
  ...
  ※重要: 業務上必要な事実指摘・妥当な改善要求だけならハラスメント度は低く（40未満）。
  ※「改善しましょう」「次気をつけて」だけの短い指導はハラスメント度10-20、指導不足（insufficient）です。労基相談（80以上）にはしません。
  ※侮辱・人格否定は言葉の表層だけでなく意味で判定する。愚か・卑しい・劣る・ばか 等は高得点。
...
必ず以下のJSONのみを返してください。説明文は不要です。
{
  ...
  "matchedRiskWords": ["指導文から検出したリスク表現（侮辱・脅し・威圧など）。意味上の人格攻撃も含め、該当語句をそのまま列挙。無ければ空配列"],
  "matchedGoodWords": []
}

※ matchedRiskWords は、キーワードリストに無い侮辱（愚か・卑しい・劣る 等）も、意味上該当すれば指導文の該当部分を入れること。
※ matchedGoodWords は空配列で構いません。
