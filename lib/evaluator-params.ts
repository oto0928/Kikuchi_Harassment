...
export const EVALUATOR_PARAMS = {
  ...
  llmClarityMargin: 20,
  /** キーワード未検出でも、LLMが意味上の侮辱を検出したと判断するハラスメント度の下限 */
  llmHarassmentSemanticTrust: 45,
} as const;
...
// 類型2「精神的な攻撃」：侮辱・人格否定
// 表記ゆれ（漢字・カタカナ・ひらがな）を登録。「ばか」単体は「ばかり」と誤爆しやすいため
// INSULT_PATTERN_CHECKS（evaluator.ts）で文脈付き検出する。
